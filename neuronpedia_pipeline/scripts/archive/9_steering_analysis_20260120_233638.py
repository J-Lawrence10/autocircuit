    ...
    def predict_intervention_effect(self, target_type, target_id, intervention_type):
        ...
        if target_type == 'supernode':
            ...
            return {
                ...
                'confidence': 'medium',  # Circuit-level prediction has medium confidence
                'explanation': f"Predicted {predicted_impact:.1%} change in output probability based on graph structure"
            }
...
def main():
    ...
    parser.add_argument('--output-dir', type=str, required=True,
                       help='Output directory for steering analysis results')
    ...
    analyzer = SteeringAnalyzer(args.analysis)
